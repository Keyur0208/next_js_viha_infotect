            ...
            <div className="side">
                <div className="container p-lg-5 p-3 ">
                    <div className="footer-header">
                        ...
                        <div>
                            <div className="footer-header-contect">
                                <div>
                                    <svg  widths={33} height={33}  viewBox="0 0 33 33" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div className="contact-icon-number">
                                    <p>Call Any Tim</p>
                                    <h6>
                    ...
                    <div className="footer-center">
                        <div className="row pt-5 gy-5">
                            <div className="col-12 col-sm-12 col-md-12 col-lg-11 col-xl-6">
                                <div className="row gx-4 gy-5">
                                    <div className="col-12 col-sm-12 col-md-8 col-lg-9 col-xl-7">
                                        <div className="footer-center-contect-info">
                                            <h4>
                                                Our Solutions
                                            </h4>
                                            <br></br>
                                            <Link href="/mobile_development">Mobile Application Development</Link>
                                            <br></br>
                                            <Link href="/web_development">Web  Application Development</Link>
                                            <br></br>
                                            <Link href="/sharepoint">SharePoint Development</Link>
                                            <br></br>
                                            <Link href="/dontnet">Dotnet Development</Link>
                                            <br></br>
                                            <Link href="/ul_xi_development">UI/UX Design & Development</Link>
                                            <br></br>
                                            <Link href="/seo_marketing">SEO & Digital Marketing</Link>
                                            <br></br>
                                            <Link href="/quality">Quality Assurance</Link>
                                        </div>
                                    </div>
                                    <div className="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-5">
                                        <div className="footer-center-contect-info">
                                            <h4>
                                                Company
                                            </h4>
                                            ...
                                            <br></br>
                                            <Link href="/news_article">News & Article</Link>
                                            <br></br>
                                            <Link href="/team">Our Team</Link>
                                            <br></br>
                                            <Link href="/our_works">Our Work</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-6">
                                <div className="row gx-4 gy-5">
                                    <div className="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-7">
                                        <div className="footer-center-contect">
                                            <h4>
                                    ...
                                    <div className="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-5">
                                        <div className="footer-center-contect">
                                            <h4>
                                                <img 
                                                src="/asset 62.svg" 
                                    ...
                                    <div>
                                        <div className="footer-center-heading">
                                            <div className="footer-center-titel">
                    ...
                    <div className="footer-end">
                        <div className="copyright">
                            © COPYRIGHT 2019 - 2023 , VIHA INFOTECH LLP, ALL RIGHTS RESERVED.
                        </div>
